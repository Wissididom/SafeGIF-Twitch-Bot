...
def main():
    ...
    print(safegif.process_gif('http://webaim.org/articles/seizure/media/flicker.gif'))
    print(safegif.process_gif('http://webaim.org/articles/seizure/media/illusion.gif'))
